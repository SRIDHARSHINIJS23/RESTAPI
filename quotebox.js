...
function RandomQuoteBox() {
  ...
  return (
    <div className="quote-box-container"style={{ backgroundColor: color }}>
      <div className="quote-box" style={{ backgroundColor: 'white' }}>
        <p className="quote-text" style={{color:color}}>{quote.quote}</p>
        <p className="quote-author" style={{color:color}}>{quote.author}</p>
      <button className="quote-button" style={{ color: color }} onClick={updateQuote}>New Quote</button>
      </div>
    </div>
  );
}
